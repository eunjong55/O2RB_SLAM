...
public:
    ...
    vector<size_t> GetFeaturesInArea_sh(const float &x, const float &y, const float  &z, const float &r, const int minLevel=-1, const int maxLevel=-1) const;
...
public:
    ...
    // Normalized sperical coordinates
    std::vector<cv::Point3f> mvKeysSp;
